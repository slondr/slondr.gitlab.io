...
The website is hosted on Gitlab.com Pages and updated via Gitlab CI. The current version is =2.2.3.3= - you can view the full version release history in the tags.
